...
const Skills = () => {
  return (
    <section id="skills" className="pt-[3rem]">
      <div className="w-[80%]  m-auto">
        <h1>skills</h1>
        <div className="grid gap-x-[6rem] phone:gap-x-[2rem] phone:grid-cols-1 tab:grid-cols-2 grid-cols-2 ">
          <div className="rounded-[3rem] phone:gap-y-[2rem] bg-white shadow-r px-[2rem] gap-x-[2rem] hover:scale-[1.03] hover:cursor-pointer p-[1rem]">
            ...
            <div className="grid phone:grid-cols-2 phone:gap-x-[1.5rem] grid-cols-3 w-[100%] h-auto ">
          ...
          <div className="rounded-[3rem] bg-white shadow-r px-[2rem] gap-x-[2rem] phone:mt-[3rem] p-[1rem] hover:scale-[1.03] hover:cursor-pointer">
            <h5 className="text-center underline underline-offset-8 decoration-orange font-garamond font-bold text-xl pb-[1rem]">
              Design
            </h5>
            <div className="grid grid-cols-2 w-[100%] h-auto phone:gap-x-[1.5rem]">
